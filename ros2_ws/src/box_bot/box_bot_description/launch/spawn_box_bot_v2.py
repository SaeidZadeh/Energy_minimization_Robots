...
def main():
    ...
    parser.add_argument('--mesh_file', type=str, default='package://box_bot_description/meshes/default.dae',
                        help='Mesh file for the robot')
    ...
    node.get_logger().info('Color is {}'.format(args.color))
    ...
    for arg in root.iter('arg'):
        ...
        if arg.attrib['name'] == 'mesh_file':
            arg.attrib['default'] = args.mesh_file
